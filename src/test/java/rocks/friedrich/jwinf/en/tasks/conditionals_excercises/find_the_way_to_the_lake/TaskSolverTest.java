...
public class TaskSolverTest {
  ...
  void testEasy() throws Exception {
    ...
    assertArrayEquals(w.actor.reportRoute(),
        new String[] { "forward", "forward", "forward", "forward", "forward", "forward", "turnLeft",
            //
            "forward", "forward", "forward", "forward", "forward", "forward", "turnLeft",
            //
            "forward", "forward", "forward", "forward", "forward", "turnLeft" });
  }
