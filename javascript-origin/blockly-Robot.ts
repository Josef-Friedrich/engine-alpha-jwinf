...
var getContext = function(display, infos, curLevel) {
   ...
   infos.newBlocks.push({
      ...
      func: function(callback) {
         this.callCallback(callback, this.isOn(function(obj: Item) { return obj.isWithdrawable === true;}));
      }
   });
   ...
   infos.newBlocks.push({
      ...
      func: function(callback) {
         this.callCallback(callback, this.isOn(function(obj: Item) { return obj.isContainer === true;}));
      }
   });
   ...
   infos.newBlocks.push({
      ...
      func: function(callback) {
         this.callCallback(callback, this.isOn(function(obj: Item) { return obj.value !== undefined;}));
      }
   });
	...
	infos.newBlocks.push({
      ...
      func: function(callback) {
         this.callCallback(callback, this.isOn(function(obj: Item) { return obj.isLaser === true;}));
      }
   });
   ...
   infos.newBlocks.push({
      ...
      func: function(callback) {
         this.callCallback(callback, this.isOn(function(obj: Item) { return obj.isWritable === true; }));
      }
   });
   ...
   infos.newBlocks.push({
      ...
      func: function(callback) {
         var robot = this.getRobot();
         this.callCallback(callback, this.getItemsOn(robot.row, robot.col, function(obj: Item) { return obj.isWithdrawable === true; }).length);
      }
   });
   ...
   infos.newBlocks.push({
      ...
      func: function(callback) {
         var robot = this.getRobot();
         var containers = this.getItemsOn(robot.row, robot.col, function(obj: Item) { return obj.isContainer === true; });
   ...
   infos.newBlocks.push({
      ...
      func: function(callback) {
         this.callCallback(callback, this.isInFront(function(obj: Item) { return obj.isPushable === true; }));
      }
   });
