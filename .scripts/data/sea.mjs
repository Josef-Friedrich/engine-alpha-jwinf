...
export default subTask;
  subTask.gridInfos = {
     ...
     borderColor: "#49b675",
      ...
      itemTypes: {
        robot: { img: "pink_robot.png", side: 80, nbStates: 9, isRobot: true, offsetX: -20, zOrder: 2 },
         road: { num: 1, img: "road.png", side: 60, isObstacle: false, zOrder: 0 },
         sand: { num: 3, img: "sand.png", side: 60, isObstacle: true, zOrder: 0 },
         beach_tl: { num: 6, img: "Beach_tl.png", side: 60, isObstacle: true, zOrder: 0 },
         beach_tr: { num: 7, img: "Beach_tr.png", side: 60, isObstacle: true, zOrder: 0 },
         beach_bl: { num: 8, img: "Beach_bl.png", side: 60, isObstacle: true, zOrder: 0 },
         beach_br: { num: 9, img: "Beach_br.png", side: 60, isObstacle: false, isExit:true,zOrder: 0 },
         bush: { num: 2, img: "bush.png", side: 60, isObstacle: true,  zOrder: 0 },
         water: { num: 4, img: "water.png", side: 60, isObstacle: false, isExit:true, zOrder: 0 },
         gras: { num: 5, img: "grass.png", side: 60, isObstacle: true, zOrder: 0 },
         water_full: { num: 17, img: "water_full.png", side: 60, isObstacle: true, zOrder: 1 },
         tree: { num: 15, img: "tree.png", side: 80, isObstacle: true, zOrder: 2, offsetX: -10, offsetY: 8 },
         flowers: { num: 16, img: "flowers.png", side: 50, isObstacle: true, zOrder: 1, offsetX: 5 },
         obstacle_small: { num: 10, img: "grey_brick_wall_small.png", side: 60, isObstacle: true, zOrder: 0 },
      },
     maxInstructions: {
           easy: 10,
           medium: 10,
